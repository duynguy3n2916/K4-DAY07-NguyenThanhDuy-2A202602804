...
**Thành viên:** Nguyễn Vũ Anh, Phạm Quang Đạt, Nguyễn Thành Duy, Trương Việt Anh

**Ngày:** 19/09/2026

> Báo cáo này tổng hợp kết quả từ bốn báo cáo cá nhân. Bộ benchmark chính thức của nhóm gồm đúng 5 câu hỏi ở Phần 3. Ba thành viên Phạm Quang Đạt, Nguyễn Thành Duy và Trương Việt Anh đã chạy đúng bộ câu hỏi này. Nguyễn Vũ Anh chạy một phiên bản benchmark sớm hơn trên cùng corpus và cùng các nhóm nghiệp vụ; kết quả đó được dùng như một stress test bổ sung và không được coi là phép so sánh ngang hàng tuyệt đối.
...
| Nguyễn Thành Duy | `SentenceChunker` | `max_sentences_per_chunk=3`; 32 chunks; TB 322,28 ký tự | `TF-IDF (unigram + bigram, L2 norm, scikit-learn)` | Không cắt gãy câu; Q2 cho thấy câu về lệ phí có thể bị đẩy sang chunk kế tiếp. |
...
| Nguyễn Thành Duy — Sentence | 5/5 tài liệu đúng ở top-1; **9/10 theo rubric nghiêm ngặt** | Bảo toàn câu; Q1, Q3–Q5 có đủ bằng chứng. | Q2 lấy đúng nơi nộp và 7 ngày nhưng câu trả lời thiếu chi tiết lệ phí, nên tính 1/2 cho câu này. |
