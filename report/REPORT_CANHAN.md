...
> Khi đối chiếu với chiến lược của các thành viên trong nhóm Magician, tôi nhận thấy chiến lược `HeadingSectionChunker` của bạn Trương Việt Anh và `HeadingRecursiveChunker` của bạn Nguyễn Vũ Anh gom trọn vẹn được cả đoạn nộp đơn và đoạn đóng lệ phí ở Q2 vào chung một chunk theo cấu trúc đề mục `##`, giúp agent trả lời đủ 100% bằng chứng mà không bị đứt đoạn như `SentenceChunker(3)` của tôi (vốn bị cắt cứng tại câu thứ 3 nên câu 4 về lệ phí bị đẩy sang chunk sau). Tuy nhiên, so với `FixedSizeChunker` của bạn Phạm Quang Đạt, chiến lược theo câu của tôi không bao giờ cắt ngang giữa từ hay phá vỡ cú pháp pháp lý. Bài học đắt giá nhất là chiến lược chunking cần phản ánh cấu trúc logic của văn bản: với quy chế học vụ, phân đoạn theo câu kết hợp cơ chế overlap câu (hoặc gom theo heading/section) là giải pháp tối ưu toàn diện.
